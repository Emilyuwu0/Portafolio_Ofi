...
<div className="p-12 md:p-10 text-center md:text-left" >
      <h1 className="text-xl md:text-2xl mb-4 md:mb-6 font-semibold text-white">
        Mira mi <span className="text-colorTertiary">Currículum</span>
      </h1>
      <p className="text-white text-base md:text-lg">
        Mi pasión por desarrollar me impulsa a ofrecer resultados excepcionales y contribuir de manera significativa a cualquier equipo en el que me encuentre. Estoy emocionado por las oportunidades futuras y espero aplicar mis habilidades y experiencia para alcanzar nuevos logros.
      </p>
    </div>
    <div className="p-4 md:p-10 text-center">
      <section className="product-container product-1">
        <a
          target="_blank"
          href="https://www.canva.com/design/DAFKtaj7nlY/lWXClJYxIEESqj7jOYIp7Q/edit?utm_content=DAFKtaj7nlY&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton"
        ...
        >
          <div className="e-card playing">
            ...
            <div className="infotop">
              ...
              Curriculum
              <br />
              <div className="name">Presioname!</div>
            </div>
          </div>
        </a>
      </section>
